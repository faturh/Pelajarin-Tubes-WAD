...
<div class="min-h-full">
  ...
  <!-- <header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">Jobseaker Page</h1>
    </div>
  </header> -->
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                  ...
                  <div class="p-4">
                      ...
                      <!-- Learn More Button -->
                      <a href="{{ route('halaman_jobseaker', $jobseaker->JobseakerId) }}" target="_blank" class="btn btn-info text-white bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-md">
                          Learn More
                      </a>
                  </div>
              </div>
